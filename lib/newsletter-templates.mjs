...
export const templates=[
 {id:"invitation",name:"United Europe Tour · Master",description:"Based on the supplied United EU Tour newsletter: two programme cards, booking links and a video teaser. Plum, rose and warm white.",accent:"#835256",campaignName:"SY Europe Tour · Gemeinsam in München"},
 {id:"journal",name:"München Community Journal · Master",description:"Based on the supplied latest newsletter: five retrospective stories, collage-ready photo galleries and individual album links.",accent:"#175cdf",campaignName:"Sahaja Yoga · Ein Sommer voller Begegnungen"},
